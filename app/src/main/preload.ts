...
contextBridge.exposeInMainWorld('sb', {
  ...
  lintComputed: () => ipcRenderer.invoke(IPC.lintComputed),
  rejectDuplicate: (a: string, b: string) => ipcRenderer.invoke(IPC.rejectDuplicate, a, b),
  unrejectDuplicate: (a: string, b: string) => ipcRenderer.invoke(IPC.unrejectDuplicate, a, b),
  rejectedDuplicates: () => ipcRenderer.invoke(IPC.rejectedDuplicates),
